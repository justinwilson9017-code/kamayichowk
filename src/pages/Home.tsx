...
export default function Home({ user }: { user: User | null }) {
  return (
    ...
    >
      <div className="max-w-3xl w-full text-center space-y-6 sm:space-y-8 py-10 sm:py-20">
        <motion.div
          initial={{ y: 20, opacity: 0 }}
          animate={{ y: 0, opacity: 1 }}
          className="inline-flex items-center gap-2 px-3 py-1 bg-emerald-50 dark:bg-emerald-900/20 text-emerald-600 dark:text-emerald-400 rounded-full text-[10px] sm:text-xs font-semibold"
        >
        ...
        <motion.h1 
          ...
          className="text-4xl sm:text-6xl font-bold tracking-tight text-zinc-900 dark:text-white leading-tight"
        >
        ...
        <motion.p 
          ...
          className="text-base sm:text-lg text-zinc-600 dark:text-zinc-400 max-w-xl mx-auto"
        >
        ...
        >
          <Link
            ...
            className="w-full sm:w-auto px-8 py-4 bg-emerald-500 hover:bg-emerald-600 text-white font-semibold rounded-xl transition-all flex items-center justify-center gap-2 shadow-lg shadow-emerald-500/20"
          >
            Find Work
